...
| 8.3 | 本地基础食物库 | [06-food-catalog.md](06-food-catalog.md) | 待补齐 |
...
| 设计稿新增 | 数据与计划、统一同步、里程碑弹窗、设置 | [07-design-interaction-backend-capabilities.md](07-design-interaction-backend-capabilities.md) | 待补齐 |
| 横切能力 | 日志、线上排障、AI 调用审计 | [08-backend-logging-observability.md](08-backend-logging-observability.md) | 不涉及客户端接口 |
...
- 设计稿新增交互后端能力补齐方案：`07-design-interaction-backend-capabilities.md`
- 日志与可观测性方案：`08-backend-logging-observability.md`
