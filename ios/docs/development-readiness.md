...
9. `docs/product/v1.1-acceptance-criteria.md`
10. `docs/api/openapi.yaml`
11. `docs/product/prd-v1.1.md`
...
```text
请读取 AGENTS.md、ios/AGENTS.md、docs/project-state.md、ios/docs/development-readiness.md、ios/docs/infrastructure-status.md、ios/docs/design-screen-map.md 和 docs/product/v1.1-acceptance-criteria.md，继续 LeanMate V1.1 iOS。iOS 基础设施、设计稿画面映射和基础单元测试 Target 已完成；App 构建和 build-for-testing 已通过，业务开发尚未开始。是否进入业务开发阶段由我确认，不要实现超出 V1.1 PRD、验收标准、OpenAPI 和 design/app/LeanMateV1.0-shikaka.pen 的功能。
```
