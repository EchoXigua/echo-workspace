...
设计稿画面映射见 `ios/docs/design-screen-map.md`。
第 1 批业务状态矩阵见 `ios/docs/v1.1-state-matrix.md`。
V1.1 验收标准与业务边界见 `docs/product/v1.1-acceptance-criteria.md`。
基础单元测试 Target 已加入 `LeanMateTests`；App 构建和 build-for-testing 已通过。
...
8. `ios/docs/design-screen-map.md`
9. `ios/docs/v1.1-state-matrix.md`
10. `docs/product/v1.1-acceptance-criteria.md`
11. `docs/api/openapi.yaml`
12. `docs/product/prd-v1.1.md`
...
当前沙箱无法访问具名 iOS Simulator 执行真实 `xcodebuild test`。进入业务开发前建议在本机可用模拟器上运行：
...
```text
请读取 AGENTS.md、ios/AGENTS.md、docs/project-state.md、ios/docs/development-readiness.md、ios/docs/infrastructure-status.md、ios/docs/design-screen-map.md、ios/docs/v1.1-state-matrix.md 和 docs/product/v1.1-acceptance-criteria.md，继续 LeanMate V1.1 iOS。iOS 基础设施、设计稿画面映射、状态矩阵和基础单元测试 Target 已完成；App 构建和 build-for-testing 已通过，业务开发尚未开始。是否进入业务开发阶段由我确认，不要实现超出 V1.1 PRD、验收标准、OpenAPI 和 design/app/LeanMateV1.0-shikaka.pen 的功能。
```
